sap.ui.define([
	...
	return Controller.extend("com.ittumi.compgastos.comprobaciones.controller.NewSolicitud", {
		...
		onInit : function () {
			...
			sap.ui.core.UIComponent.getRouterFor(this).attachRouteMatched(function(oEvent) {
	        	...
	        	console.log("sRoute3:" + sRoute);
	        	if ("new-solicitud" === sRoute) {
		        	var oForm = oView.byId('solicitudForm');
		        	oView.getModel('comprobaciones').refresh(true);
...
//			   <d:Status>01</d:Status>
			...
			oView.getModel('comprobaciones').resetChanges(function(){},function(){});
			
		    var oContext = oView.getModel('comprobaciones').createEntry("RequestHeaderSet",
	    		{
...
//	    		    "Langu" : "S" // Hardcoded
		    ...
		    var callBacks = {
		    	...
		    	error : function (oError) {
		    		console.log('error');
		    		oView.getModel('comprobaciones').deleteCreatedEntry(oContext); // a must, when submitChanges returns error
		    		MessageBox.error("Error al grabar datos. ");
		    	}
	    	}
		    
		    oView.getModel('comprobaciones').submitChanges(callBacks.success, callBacks.error);
