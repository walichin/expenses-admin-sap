sap.ui.define([
	...
	return Controller.extend("com.ittumi.compgastos.anticipos.controller.AnticiposList", {
		...
		onInit : function () {
	        ...
	        sap.ui.core.UIComponent.getRouterFor(this).attachRouteMatched(function(oEvent) {
	        	...
	        	console.log("AnticiposList - attachRouteMatched called with route:" + sRoute);
	        	if ("list" === sRoute) {
	        		console.log("AnticiposList - attachRouteMatched with route " + sRoute + " matches!");
		        	// New Implementation : oData for Entity : Using filter object
		        	var oModel = oView.getModel('anticipos');
		        	var oTable = oView.byId('AdvancesListTable');
					var oBinding = oTable.getBinding("items");
					
				    // Hack - Start
				    var statusA = oView.byId('statusAnticipoBox').getProperty('selectedKey');
				    if (statusA === '00') statusA = '  '; 
				    // Hack - end
					...
					var oFilter4 = new sap.ui.model.Filter("StatusA", sap.ui.model.FilterOperator.EQ, statusA);
