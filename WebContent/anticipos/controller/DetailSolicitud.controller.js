sap.ui.define([
	...
	return Controller.extend("com.ittumi.compgastos.anticipos.controller.DetailSolicitud", {
		...
		onInit : function () {
			...
			sap.ui.core.UIComponent.getRouterFor(this).attachRouteMatched(function(oEvent) {
	        	...
	        	console.log("DetailSolicitud - attachRouteMatched called with route:" + sRoute);
	        	
	        	if ("show-solicitud" === sRoute) {
	        		console.log("DetailSolicitud - attachRouteMatched with route " + sRoute + " matches!");
		        	if (oEvent.getParameter("arguments").Expenseid) {
			        	...
			        	oView.bindElement("anticipos>" + oPath);
		...
		saveSolicitud : function(oEvent) {
		    ...
		    var oData = oView.getBindingContext("anticipos").getProperty("/RequestHeaderSet(Bukrs='"+Bukrs+"',Expenseid='"+Expenseid+"',Langu='ES')");
		    
		    console.log(oData.Buktx);
		    
		    oView.getModel('anticipos').update("/RequestHeaderSet(Bukrs='"+Bukrs+"',Expenseid='"+Expenseid+"',Langu='ES')",
		    		{
		    		  "d" : {
		    		    "Bukrs" : oData.Bukrs,
		    		    "Expenseid" : Expenseid,
